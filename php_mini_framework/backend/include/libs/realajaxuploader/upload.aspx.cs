...
public partial class upload : System.Web.UI.Page
{
    ...
    {   
         ...
         ***********************************************************************************************************/
        string upload_path      = Server.MapPath(string.IsNullOrEmpty(Request.QueryString["ax-file-path"]) ? "" : Request.QueryString["ax-file-path"]);
        string max_file_size    = string.IsNullOrEmpty(Request.QueryString["ax-max-file-size"]) ? "10M" : Request.QueryString["ax-max-file-size"];
        ...
        ********************************************************************************************************/
        string file_name    = string.IsNullOrEmpty(Request.QueryString["ax-file-name"]) ? "" : Request.QueryString["ax-file-name"];
        int curr_byte       = string.IsNullOrEmpty(Request.QueryString["ax-start-byte"]) ? 0 : Convert.ToInt32(Request.QueryString["ax-start-byte"]);
        int full_size       = string.IsNullOrEmpty(Request.QueryString["ax-file-size"]) ? 0 : Convert.ToInt32(Request.QueryString["ax-file-size"]);
        string is_last      = string.IsNullOrEmpty(Request.QueryString["ax-last-chunk"]) ? "true" : Request.QueryString["ax-last-chunk"];
        bool is_ajax        = (!string.IsNullOrEmpty(Request.QueryString["ax-last-chunk"]) && !string.IsNullOrEmpty(Request.QueryString["ax-start-byte"]));
        /**********************************************************************************************************/
